  ...
  if($showDate == 'true'){ $date_class = "has-date";}else{$date_class = "has-no-date";} ?>
   ...
   <div id="post-<?php the_ID(); ?>" class="news type-news news-col-<?php echo $gridcol.' '.$css_class.' '.$date_class; ?>" style="padding-right: 10px; padding-left: 0px; margin-bottom: 0px !important;">
      <div class="news-thumb">
      	<?php $student_image = $student_image = ($student->display('alumni_image'))? $student->display('alumni_image'):$student->display('student_image');  ?>
      ...
      <div class="news-content">
         <div class="post-content-text">
            ...
            <?php the_title( sprintf( '<h6 class="news-title"><strong><a>'.$student->display('student_id').'</a></strong><br>', esc_url( get_permalink() ) ), '</h6>' );?>
            <div class="grid-date-post">
               <strong> <?php echo $cate_name; ?> </strong>
                ...
                ?></td>
								...
								<td><?php echo "&nbsp;".substr($student->display('hobbies'),3,$end_p-3); ?></td>
								</tr>
								<tr>
                ...
                <?php endif ?>
								<?php if ($student->display('cv')): ?>
								<tr>
								<td><strong>CV</strong></td>
								<td><?php echo "&nbsp;".do_shortcode('[su_button url="'.$student->display('cv').'" target="blank" style="flat" background="#42a4d6" size="2" icon="icon: cloud-download" rel="lightbox"]Download[/su_button]' ); ?></td>
								</tr>
								<?php endif; ?>
