...
<footer id="colophon" class="site-footer" role="contentinfo">
	...
	<?php echo apply_filters( 'vantage_footer_attribution', '<div id="theme-attribution">' . sprintf( __('<a href="%s">Copyright © 2017. Biomedical Engineering Department <br> International University - Vietnam National University - Ho Chi Minh City</a>', 'vantage'), '#') . '</div>' ) ?>
