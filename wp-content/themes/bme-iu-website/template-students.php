    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <div class="entry-main">
        ...
        <?php 
          ...
          <?php
          // Display students
          $content = '[bme_student type="student" degree="'.$degree.'" academic_year="'.$academic_year.'" graduation_year="'.$graduation_year.'" research_interest="'.$research_interest.'" tag_logic="" pagination_type="numeric" limit="'.$student_per_page.'" grid="3" show_date="false" show_content="true" show_category_name="true" content_words_limit="30"]';
